...
# Welcome to my section of our IRSAE summer school presentation! This script was written to be fully 
...
# First of all, if you have any questions or want to get in touch, contact me at sam@ducky.eco
# or on Twitter at @BigDrFishBoi.
...
# this all runs a bit faster during the workshop. Obviously subsetting like this isn't always recommended,
...
### EXTENDED QUESTIONS ####
# Have a look at ordination plots grouping the species by latent variable response using the commabd below.
...
# Can you spot any correspondences between these plots and the correlation plots above?


#######################################################
# Have any extra questions? Contact me directly via email at sam@ducky.eco or
# on Twitter at @BigDrFishBoi.
######################################################
